...
function registerForUpdate(){
	function updater() {
		...
		if (washer_state.freeIn != null){
			...
			$("#lblWasherIds").text((washer_state.nextGoIds.lenght > 0 ? "Machines ": "Machine ") + washer_state.nextGoIds.join(", "));
		...
		if (dryer_state.freeIn != null){
			...
			$("#lblDryerIds").text((dryer_state.nextGoIds.lenght > 0 ? "Machines ": "Machine ") + dryer_state.nextGoIds.join(", "));
